...
class DataFrameReader(OptionUtils):
    ...
    def json(self, path, schema=None, primitivesAsString=None, prefersDecimal=None,
             ...
             multiLine=None, allowUnquotedControlChars=None, lineSep=None, encoding=None):
        """
        ...
        self._set_opts(
            ...
            allowUnquotedControlChars=allowUnquotedControlChars, lineSep=lineSep, encoding=encoding)
        if isinstance(path, basestring):
            path = [path]
        if type(path) == list:
