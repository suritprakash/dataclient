...
class SparkSession(object):
    ...
    def _wrap_data_schema(self, data, schema):
    ...
    def _createFromLocalTrusted(self, data, schema):
        ...
        tempDir = self._jsparkSession.getTrustedPath()
        # Create the temp file to dump data, this file would be deleted by the createDF call
        tempFile = NamedTemporaryFile(delete=False, dir=tempDir)
        ...
        return self._jsparkSession.createDataFrameFromTrustedPath(tempFile.name, schema.json()),\
            schema
    ...
    def createDataFrame(self, data, schema=None, samplingRatio=None, verifySchema=True):
        ...
        if self._sc._conf.get(
            ...
            jdf, schema = self._createFromLocalTrusted(map(prepare, data), schema)
        else:
